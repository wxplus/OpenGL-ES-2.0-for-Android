...
***/
package wxplus.opengles2forandroid.data;
...
public class IndexBuffer {
    ...
    public IndexBuffer(float[] indexData) {
        // Allocate a buffer.
        ...
        FloatBuffer indexArray = ByteBuffer
            .allocateDirect(indexData.length * BYTES_PER_FLOAT)
        ...
        glBufferData(GL_ELEMENT_ARRAY_BUFFER, indexArray.capacity() * BYTES_PER_FLOAT,
