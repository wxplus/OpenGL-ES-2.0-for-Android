...
public class OpenGL_03_Perspective_Projection extends BaseActivity {
    ...
    public class  SimpleColorRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            translateM(modelMatrix, 0, 0, 0, -4);
            rotateM(modelMatrix, 0, -60, 1f, 0, 0);
            final float[] temp = new float[16];
            // Projection Matrix * Model Matrix
            multiplyMM(temp, 0, mProjectionMatrix, 0, modelMatrix, 0);
